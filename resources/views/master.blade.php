        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">دانشجو</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <select class="form-select" aria-label="Default select example">
                        ...
                        <option value="1">رشته معماری</option>
                        <option value="2">رشته عمران</option>
                        <option value="3">رشته راه و ساختمان</option>
                        <option value="3">رشته کامپیوتر نرم افزار</option>
                    </select>
                </div>
    ...
    <div class="footer-content">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="footer-section-right col-lg-3 col-md-4 col-sm-4">
                ...
                <div class="footer-section-center col-lg-3 col-md-4 col-sm-4">
                ...
                <div class="footer-section-left col-lg-3 col-md-4 col-sm-4">
